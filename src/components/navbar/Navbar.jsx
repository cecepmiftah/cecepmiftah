  ...
  return (
    <div className="h-full flex items-center justify-between text-xl px-4 sm:px-8 md:px-12 lg:px-20 xl:px-48">
      ...
      <div className="md:hidden lg:flex xl:w-1/3 xl:justify-center">
        ...
        >
          <span className="text-white mr-1">CM</span>
      ...
      {/* SOCIALS */}
      <div className="hidden md:flex gap-4 w-1/3">
        <Link href={"https://github.com/cecepmiftah"}>
          <Image src={"/github.png"} alt="github" width={24} height={24} />
        </Link>
        <Link href={"https://www.instagram.com/cecepm999"}>
          <Image
            src={"/instagram.png"}
            alt="instagram"
            width={24}
        ...
        <Link href={"https://web.facebook.com/cecep.m.3760"}>
          <Image src={"/facebook.png"} alt="facebook" width={24} height={24} />
        </Link>
        <Link
          href={"https://www.linkedin.com/in/cecep-miftah-solahudin-28b812275/"}
        >
